    ...
    <div class="container">
        ...
        >
            ...
            <el-form
                ...
                @submit.native.prevent
            >
                <el-form-item label="条件类型" prop="dotted">
                    <el-radio-group v-model="linkSetting.dotted">
        ...
        建筑 —— 住宅型 ——如果》54米 = 高层二类建筑： 建筑 —— 住宅型 —— 27米《
        如果《54米 = 高层一类建筑： 建筑 —— 住宅型 —— 》 27米 = 底层住宅建筑
    </div>
</template>
