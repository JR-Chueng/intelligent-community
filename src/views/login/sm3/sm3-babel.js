...
/**
 * @Author: zhanglinjing
 * @description: 压缩函数中的置换函数 P1(X) = X xor (X <<< 9) xor (X <<< 17)
 * @param {*}
 * @return {*}
 */
function P0(X) {
...
/**
 * @Author: zhanglinjing
 * @description: 消息扩展中的置换函数 P1(X) = X xor (X <<< 15) xor (X <<< 23)
 * @param {*}
 * @return {*}
 */
function P1(X) {
...
/**
 * @Author: zhanglinjing
 * @description: sm3 hash算法 http://www.oscca.gov.cn/News/201012/News_1199.htm
 * @param {*}
 * @return {*}
 */
function sm3(str) {
